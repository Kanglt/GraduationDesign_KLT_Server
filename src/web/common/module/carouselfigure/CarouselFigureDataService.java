 ...
 */
public class CarouselFigureDataService {

	// Java数据服务 -begin-
	/**
	 * 通用列表查询
	 */
	public ProcedureResult getCarouselFigureList(String queryId,
			String queryFileId, String queryModuleType,
		...
		return this.sp_web_local_tax_mobile_carousel_figure_query(queryId,
				queryFileId, queryModuleType, querySeqNoStart, querySeqNoEnd,
				queryUpdateBy, queryUpdateByAddress, queryUpdateTimeStart,
				queryUpdateTimeEnd, queryCreateBy, queryCreateByAddress,
				queryCreateTimeStart, queryCreateTimeEnd, page, pageSize,
	 ...
	 * 通用新增单条记录
	 */
	public ProcedureResult newCarouselFigure(String fileId, String moduleType,
		...
		return this.sp_web_local_tax_mobile_carousel_figure_management(
				Procedure.ACTION_INSERT, id, fileId, moduleType, seqNo,
	 ...
	 * 通用删除单条记录
	 */
	public ProcedureResult deleteCarouselFigure(String id,
		...
		return this.sp_web_local_tax_mobile_carousel_figure_management(
				Procedure.ACTION_DELETE, id, fileId, moduleType, seqNo,
				operatorId, operatorAddress, recordVersion);
	}
	 ...
	 * 通用单条记录查询
	 */
	public ProcedureResult getCarouselFigure(String id, String operatorId,
			String operatorAddress) throws Exception {

		return this.sp_web_local_tax_mobile_carousel_figure_read(id,
				operatorId, operatorAddress);
	}
	 ...
	 * 通用修改单条记录
	 */
	public ProcedureResult updateCarouselFigure(String id, String fileId,
			String moduleType, Integer seqNo, String operatorId,
			String operatorAddress, Integer recordVersion) throws Exception {

		return this.sp_web_local_tax_mobile_carousel_figure_management(
				Procedure.ACTION_UPDATE, id, fileId, moduleType, seqNo,
				operatorId, operatorAddress, recordVersion);
	}
	 ...
	 * 增、删、改存储过程
	 */
	private ProcedureResult sp_web_local_tax_mobile_carousel_figure_management(
			String action, String id, String fileId, String moduleType,
			Integer seqNo, String operatorId, String operatorAddress,
			Integer recordVersion) throws Exception {

		Procedure procedure = new Procedure(
				"sp_web_local_tax_mobile_carousel_figure_management");

		procedure.addParameterString("action", action);
		procedure.addParameterString("id", id);

		procedure.addParameterString("fileId", fileId);
		procedure.addParameterString("moduleType", moduleType);
	 ...
	 * 列表查询存储过程
	 */
	private ProcedureResult sp_web_local_tax_mobile_carousel_figure_query(
			String queryId, String queryFileId, String queryModuleType,
			Integer querySeqNoStart, Integer querySeqNoEnd,
			String queryUpdateBy, String queryUpdateByAddress,
			Timestamp queryUpdateTimeStart, Timestamp queryUpdateTimeEnd,
			String queryCreateBy, String queryCreateByAddress,
		...
		Procedure procedure = new Procedure(
				"sp_web_local_tax_mobile_carousel_figure_query");

		procedure.addParameterString("queryId", queryId);

		procedure.addParameterString("queryFileId", queryFileId);
		procedure.addParameterString("queryModuleType", queryModuleType);
	 ...
	 * 单条记录查询存储过程
	 */
	private ProcedureResult sp_web_local_tax_mobile_carousel_figure_read(
			String id, String operatorId, String operatorAddress)
			throws Exception {

		Procedure procedure = new Procedure(
				"sp_web_local_tax_mobile_carousel_figure_read");
