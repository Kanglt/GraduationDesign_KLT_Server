...
/**
 * @ClassName: UserDynamicImageDispatcher
 * @Description: TODO(用户动态中的图片上传)
 * @author 康良涛
 * @date 2016年12月20日 下午10:55:26
 * 
 */
public class UserDynamicImageDispatcher extends HttpServlet {

	private static Log log = LogFactory.getLog(UserDynamicImageDispatcher.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("temp=" + realPath);
		String loadpath = getServletContext().getRealPath("image/user_dynamic_image"); // 上传文件存放目录
		File dir2 = new File(loadpath);
		if (!dir2.exists()) {
			dir2.mkdir();
		}
