...
public class Utils {
	...
	public static java.sql.Timestamp getTimestampZero() {
	...
	public static java.sql.Timestamp parseTimestamp(String datetimeString)
			throws Exception {
	...
	public static java.sql.Timestamp parseTimestamp(String datetimeString,String simpleDateFormat)
			throws Exception {
		SimpleDateFormat simpleDatetimeSecondFormat = new SimpleDateFormat(
				simpleDateFormat);
		return new java.sql.Timestamp(
	...
	public static java.util.Date getDateByTimestamp(Timestamp timestamp) {
	...
	public static JSONObject objectToJSONObject(Object obj) throws Exception {
		BeanMap beanMap = new BeanMap(obj);

		JSONObject result = new JSONObject();
		Iterator<Entry> iterator = beanMap.entryIterator();
		while (iterator.hasNext()) {
	...
	public static void main(String[] args) throws Exception {
		User user = new User("1001", "jam", "p123", "卡卡西");
		JSONObject result = Utils.objectToJSONObject(user);
